...
class Utils {
    ...
    companion object {
        ...
        fun getAddress(appcompactivty:AppCompatActivity,latitude: Double, longitude: Double){
//            val geocoder = Geocoder(appcompactivty, Locale.getDefault())
//            val addresses: List<Address>? = geocoder.getFromLocation(latitude, longitude, 1)
//            val addresses1: List<Address>? = geocoder.getFromLocation(latitude,longitude,1)
